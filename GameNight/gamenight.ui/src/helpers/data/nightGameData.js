...
const removeByGroupId = (groupId) => axios.delete(`${nightGameUrl}/group/${groupId}`).catch((err) => console.warn(err));

export default {
  getByNightId, addGameToNight, removeByGameId, removeByNightId, removeByGroupId
};
